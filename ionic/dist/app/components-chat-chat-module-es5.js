...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components-chat-chat-module"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsChatChatComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<app-toolbar (onlineUsers)=\"online($event)\"></app-toolbar>\n\n<div class=\"container\" style=\"margin-top: 30px\">\n    <div class=\"row chatRow\">\n        <div class=\"col s12\">\n            <app-message [users]=\"online_users\"></app-message>\n        </div>\n    </div>\n</div>";
    /***/
  },
  ...
  /***/
  function srcAppComponentsChatChatRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _chat_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./chat.component */
    ...
    ChatRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
  ...
  function srcAppComponentsChatChatComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])], ChatComponent);
    /***/
  },
  ...
  /***/
  function srcAppComponentsChatChatModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var ng2_emoji_picker__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ng2-emoji-picker */
    ...
    ChatModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"], _chat_routing_module__WEBPACK_IMPORTED_MODULE_4__["ChatRoutingModule"], ng2_emoji_picker__WEBPACK_IMPORTED_MODULE_3__["EmojiPickerModule"].forRoot()]
    })], ChatModule);
    /***/
  },
  ...
  function srcAppComponentsMessageMessageComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      _createClass(MessageComponent, [{
        ...
        value: function ngOnChanges(changes) {
          ...
          if (changes.users.currentValue.length > 0) {
            var result = lodash__WEBPACK_IMPORTED_MODULE_7___default.a.indexOf(changes.users.currentValue, this.receiver);
        ...
        value: function GetUserByUsername(name) {
          ...
          this.usersService.GetUserByName(name).subscribe(function (data) {
            _this2.receiverData = data.result;

            _this2.GetMessages(_this2.user._id, data.result._id);
          });
        }
      }, {
        key: "GetMessages",
        value: function GetMessages(senderId, receiverId) {
          var _this3 = this;

          this.msgService.GetAllMessages(senderId, receiverId).subscribe(function (data) {
            _this3.messagesArray = data.messages.message;
          });
        }
      }, {
        key: "SendMessage",
        value: function SendMessage() {
          ...
          if (this.message) {
            this.msgService.SendMessage(this.user._id, this.receiverData._id, this.receiverData.username, this.message).subscribe(function (data) {
        ...
        key: "HandleCurrentCaret",
        value: function HandleCurrentCaret(event) {
          this._lastCaretEvent = event;
          this.eventPosMock = "{ caretOffset : ".concat(event.caretOffset, ", caretRange: Range{...}, textContent: ").concat(event.textContent, " }");
        }
      }, {
        key: "Toggled",
        ...
        value: function IsTyping() {
          ...
          this.typingMessage = setTimeout(function () {
            _this5.socket.emit("stop_typing", {
              sender: _this5.user.username,
              receiver: _this5.receiver
            });
          }, 500);
        }
      }]);
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Input"])(), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)], MessageComponent.prototype, "users", void 0);
    MessageComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Component"])({
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_token_service__WEBPACK_IMPORTED_MODULE_3__["TokenService"], _services_message_service__WEBPACK_IMPORTED_MODULE_2__["MessageService"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["ActivatedRoute"], _services_users_service__WEBPACK_IMPORTED_MODULE_1__["UsersService"]])], MessageComponent);
    /***/
  }
}]);
